...
export default function GuestInput({ 
  guests, setGuests, menuClassName,
  ...
  return (
    ...
    >
      ...
      { isOpenGuestMenu && (
        <div className={`
            absolute top-12 w-[110%] 
            shadow-[rgba(0,_0,_0,_0.15)_0px_2px_6px_0px,_rgba(0,_0,_0,_0.07)_0px_0px_0px_1px] 
            py-6 px-4 flex flex-col gap-8 bg-white rounded-lg right-0 z-10
            ${menuClassName}
          `}
        >
          <Counter
