...
export default function Header() {
  ...
  return (
    <header className="h-[80px] lg:px-20 md:px-10 py-4 flex justify-between items-center border-b-gray-200 border-b-[1px]  w-full bg-white">
                  ...
                  <div className='border-[1px] border-primary rounded-full p-1'>
                    { user?.avatar && 
                      <img 
                        ...
                        src={`
                          http://localhost:3000/images/users/avatars/${user?.avatar}
                        `}
                      /> 
                    }
                  </div>
