...
export default function PlacePage() {
  ...
  return (
    <>
      ...
      <div className=" lg:mt-0 lg:w-3/5 xl:w-4/5 2xl:w-3/5 mx-auto">
        { isLoading
          ? <div className="w-full text-center mt-20"><Spinner /></div>
          : <>
              <div className="p-6">
